...
namespace MyCompanyName.AbpZeroTemplate.EntityFramework
{
    ...
    public class AbpZeroTemplateDbContext : AbpZeroDbContext<Tenant, Role, User>
    {
        ...
        public virtual IDbSet<Biz_CardInfo> Biz_CardInfo { get; set; }

        public virtual IDbSet<FinancialDetails> FinancialDetails { get; set; }
        public virtual IDbSet<OrderDetail> OrderDetail { get; set; }
        public virtual IDbSet<CardIdCodes> CardIdCodes { get; set; }
