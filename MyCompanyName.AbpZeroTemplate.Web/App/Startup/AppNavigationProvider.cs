        ...
        public override void SetNavigation(INavigationProviderContext context)
        {
            ...
            mainmenu
                 .AddItem(new MenuItemDefinition(
                        PageNames.App.Common.CurrentUserInfo,
                        L("BasicUserInfo"),
                        icon: "fa fa-user",
            ...
            var cardInfo = new MenuItemDefinition(
                         AppPermissions.Biz_CardInfo,
                          L("Biz_CardInfo"),
                          url: "biz_CardInfos",
                          icon: "fa fa-id-card-o",
                          requiredPermissionName: AppPermissions.Biz_CardInfo
                          );
            var financialDetails = new MenuItemDefinition(
                              AppPermissions.FinancialDetails,
                              L("FinancialDetails"),
                              url: "financialDetailss",
                              icon: "icon-grid",
                              requiredPermissionName: AppPermissions.FinancialDetails
                           );
            var orderDetail = new MenuItemDefinition(
                             AppPermissions.OrderDetail,
                             L("OrderDetail"),
                             url: "orderDetails",
                             icon: "fa fa-file-text-o",
                             requiredPermissionName: AppPermissions.OrderDetail
                           );

            mainmenu.AddItem(cardInfo);
            mainmenu.AddItem(financialDetails);
            mainmenu.AddItem(orderDetail);
