    ...
    appModule.controller('common.views.users.index', [
        ...
        function ($scope, $uibModal, $stateParams, uiGridConstants, userService) {
            ...
            vm.permissions = {
                ...
                changeMoney: abp.auth.hasPermission('Pages.Administration.Users.ChangeMoney')
            };
                ...
                columnDefs: [
                    {
                        ...
                        cellTemplate:
                            ...
                            '      <li><a ng-if="grid.appScope.permissions.changeMoney" ng-click="grid.appScope.changeMoney(row.entity)">变更余额</a></li>' +
                            '    </ul>' +
                            '  </div>' +
                            '</div>'
                    },
            ...
            vm.changeMoney = function (user)
            {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/common/views/users/changeMoney.cshtml',
                    controller: 'common.views.users.changeMoney as vm',
                    backdrop: 'static',
                    resolve: {
                        userId: function () {
                            return user.id;
