...
appModule.config([
    ...
    function ($stateProvider, $urlRouterProvider, $qProvider) {
        ...
        $stateProvider.state('showCurrentUserInfo', {
            url: '/showCurrentUserInfo',
            templateUrl: '~/App/common/views/users/showUserInfo.cshtml'
        });
        //COMMON routes
        ...
        if (abp.auth.hasPermission('Pages.FinancialDetails')) {
            $stateProvider.state('financialDetailss', {
                url: '/financialDetailss?filterText',
                templateUrl: '~/App/common/views/financialDetailss/index.cshtml',
            });
        }

        if (abp.auth.hasPermission('Pages.OrderDetail')) {
            $stateProvider.state('orderDetails', {
                url: '/orderDetails?filterText',
                templateUrl: '~/App/common/views/orderDetail/index.cshtml',
            });
        }
        //HOST routes
        ...
        if (abp.auth.hasPermission('Pages.Biz_CardInfo')) {
            $stateProvider.state('biz_CardInfos', {
                url: '/biz_CardInfos?filterText',
                templateUrl: '~/App/common/views/biz_CardInfos/index.cshtml',
            });
        }
        //$qProvider settings
